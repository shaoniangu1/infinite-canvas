...
import { requestKieVideo } from "@/services/ai/providers/kie-provider";
    ...
    const result = videoPluginResult(
        await runModelPlugin({
            ...
            params: {
                ...
                characterOrientation: config.videoCharacterOrientation,
                backgroundSource: config.videoBackgroundSource,
                seed: config.videoSeed,
                clipStart: config.videoClipStart,
                clipEnd: config.videoClipEnd,
            },
